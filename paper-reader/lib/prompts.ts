...
- 논문의 피겨가 있으면 설명할 때 Figure/Table 번호로 명시적으로 참조할 것 (예: "Figure 1 참조", "Table 1 참조")
- 실험 결과는 숫자 나열이 아니라 의미까지 해석할 것
- 문장 종결은 반드시 명사형으로 끝낼 것. "~이다" "~한다" "~된다" 금지. 예: "높은 성능을 달성" "기존 대비 개선된 결과" "주목할 만한 차이점"
${figureContext}
${equationContext}
...
## 실험 결과 분석
이 섹션도 줄글 금지. 표/그래프별로 블록 작성:

### [표 또는 그래프 이름] (예: Table 1: 번역 성능 비교)
...
위 블록을 주요 표/그래프 수만큼 반복. 최소 2개 이상.
